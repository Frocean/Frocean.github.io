...
这个就很重点了 我们可以自己画图找找路径, 然后发现...修改的区间的dfs序编号好像连不起来?
...
(假设要算 x 和 y 的 区间)
  ...
  然后 按照lca的方法 快速地把两个点的路径走通(不会lca的记得参考前面的{{< relref-blank "树链剖分求LCA[模板] 超详细解释 + 代码" >}}那一篇{{< /relref-blank >}}!)
  
  接下来**注意** 在每一次跳之前 设要跳的点为x 则
